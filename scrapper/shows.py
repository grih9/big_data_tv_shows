...
def get_show_data(driver):
    ...
    table = driver.find_elements(By.XPATH, './/div[@class="ShowDetails__section"]//table//tr[@class="info-row"]')
    ...
    try:
        rating_count = driver.find_elements(By.XPATH, './/div[@class="ShowRating-value"]//div//span[@class="Counter"]')[
            0]
